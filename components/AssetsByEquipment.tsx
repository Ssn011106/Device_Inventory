...
interface AssetsByEquipmentProps {
  stats: EquipmentStat[];
}

const AssetsByEquipment: React.FC<AssetsByEquipmentProps> = ({ stats }) => {
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-bold text-slate-900">Assets by Equipment Description</h3>
        <span className="text-xs font-medium text-slate-500 uppercase tracking-widest">{stats.length} Categories Found</span>
      </div>
...
export default AssetsByEquipment;
